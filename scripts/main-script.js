...
// СЛАЙДЕР____________________________________________________________________________________________
...
function open(e) {
    const targetElement= e.target; // в e будет лежать тот элемент на который кликнул пользователь
    if (targetElement.closest('.block')){
